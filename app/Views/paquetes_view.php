...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('estilos_paquetes.css') ?>">
            ...
            <section class="categorias">
                <div class="ancho">
                    ...
                    <div class="lista-categorias">
                        <a class="categoria" href="<?= base_url('categoria_paquete/Todos') ?>">Todos</a>
                        <a class="categoria" href="<?= base_url('categoria_paquete/Turismo') ?>">Turismo</a>
                        <a class="categoria" href="<?= base_url('categoria_paquete/Playas') ?>">Playas</a>
                        <a class="categoria" href="<?= base_url('categoria_paquete/Aventura') ?>">Aventura</a>
                    </div>
                </div>
            </section>
